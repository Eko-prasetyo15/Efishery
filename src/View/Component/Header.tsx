  ...
  return (
    <nav className="navbar navbar-expand-lg bg-light">
      <div className="container">
        <a className="navbar-brand" href="https://efishery.com/" target="_blank">
        ...
        <div>
          <a href="https://github.com/Eko-prasetyo15" target="_blank">
            <img src="https://cdn-icons-png.flaticon.com/512/25/25231.png" className="medsos" width="30" height="30" />
          </a>
          <a href="https://www.linkedin.com/in/ekoprasetyopermadi/" target="_blank">
          ...
          <a href="https://www.facebook.com/prasetyoeko15" target="_blank">
